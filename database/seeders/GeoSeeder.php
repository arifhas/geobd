        ...
        if (($handle = fopen($file_path, "r")) !== FALSE) {
            while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
                ...
                if($row == 1) {
                    ...
                    $upazila_key = array_search("Thana", $data);
                ...
                $upazila_name = trim($data[$upazila_key]);
                ...
                $upazila = Upazila::updateOrCreate(['name' => $upazila_name, 'district_id' => $district->id]);

                PostOffice::create(['name' => $post_office_name, 'code' => $post_office_code, 'upazila_id' => $upazila->id]);
